...
amelplot <- function(popname, fill_col){
  p <- ggplot(sort.tbl, aes(x=Pop, y={{popname}})) + geom_boxplot(fill=fill_col, color="black") + coord_cartesian(ylim=c(0,1))
  p + ggtitle("Ancestry by Management") + xlab("Management") + ylab("Proportion")
  p + theme(text=element_text(size=15)) + theme_bw()
}
